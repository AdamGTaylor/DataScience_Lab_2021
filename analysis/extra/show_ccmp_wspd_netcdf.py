...
file = 'E:/_ELTE_PHYS_MSC/3_third_semester/datascience/data/wind_data/my_days/CCMP_RT_Wind_Analysis_20200120_V02.1_L3.0_RSS.nc'
...
print ('Latitude goes from ', data.dataset.variables['latitude'][0], 'to', data.dataset.variables['latitude'][-1])
